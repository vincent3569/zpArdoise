...
- colorbox, comment_form, contact_form, dynamic-locale, flag_thumbnail, GoogleMap, image_album_statistics, print_album_menu, rating, register_user, slideshow, user_login-out, zenpage
...
### Important
To use the release **1.4.3** of the theme, you must have **ZenPhoto 1.4.3.x**.
